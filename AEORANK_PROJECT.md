...
- Generates 8 files: llms.txt, schema.json, llms-full.txt, CLAUDE.md, robots-patch.txt, faq-blocks.html, citation-anchors.html, sitemap-ai.xml (`ai.txt` is neither generated nor scored on `aeorank-cli@0.1.1`)
