...
- [ ] **CSTR-01**: Scanner detects Q&A content format (question-format headings with answers) and scores 0-10
- [ ] **CSTR-02**: Scanner measures direct answer density (concise answer paragraphs after question headings) and scores 0-10
- [ ] **CSTR-03**: Scanner checks query-answer alignment (every question heading followed by a direct answer) and scores 0-10
...
- [ ] **WGHT-03**: Coherence gate caps site score when topic-coherence < 6/10
- [ ] **WGHT-04**: Duplication gate caps page score at 35% when 3+ duplicate blocks detected
...
- [ ] **SURF-02**: Docs site updated — "12 Dimensions" → "36 Criteria" across all scoring pages
- [ ] **SURF-03**: Marketing site copy updated to reference "36 criteria across 5 pillars"
...
| WGHT-03 | Phase 13 | Pending |
| WGHT-04 | Phase 13 | Pending |
