...
| Generated files | **8** | `packages/core/src/constants.ts` `GENERATED_FILE_NAMES` — llms.txt, llms-full.txt, CLAUDE.md, schema.json, robots-patch.txt, faq-blocks.html, citation-anchors.html, sitemap-ai.xml. `ai.txt` is scored if present, not generated by default. |
...
6. ~~**"8 vs 9 files" build-log discrepancy.**~~ Resolved: public claims match the 8-file `generateFiles()` list. `ai.txt` is scored, not default-generated.
