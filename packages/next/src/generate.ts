...
function generateLlmsTxt(config: AeorankNextConfig): string {
...
function generateLlmsFullTxt(config: AeorankNextConfig): string {
	const faqSection =
...
function generateClaudeMd(config: AeorankNextConfig): string {
	return `# ${config.siteName}
...
function generateSchemaJson(config: AeorankNextConfig): string {
...
function generateFaqBlocksHtml(config: AeorankNextConfig): string {
...
function generateCitationAnchorsHtml(config: AeorankNextConfig): string {
	return `<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="utf-8">
...
function generateSitemapAiXml(config: AeorankNextConfig): string {
...
const generators: Record<string, (config: AeorankNextConfig) => string> = {
 ...
 */
export function generateAeoFiles(config: AeorankNextConfig): string[] {
