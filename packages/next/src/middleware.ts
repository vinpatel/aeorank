import type { AeorankNextConfig, AeoFileName } from "./types.js";
...
/**
 * Creates a Next.js App Router GET handler that serves an AEO file.
 *
 * Usage in app/llms.txt/route.ts:
 * ```ts
 ...
 * ```
 */
export function serveAeoFile(filename: AeoFileName, config: AeorankNextConfig) {
	return () => {
