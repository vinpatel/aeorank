...
function generateLlmsTxt(config: AeorankEleventyConfig): string {
...
function generateLlmsFullTxt(config: AeorankEleventyConfig): string {
	const faqSection =
...
function generateClaudeMd(config: AeorankEleventyConfig): string {
	return `# ${config.siteName}
...
function generateSchemaJson(config: AeorankEleventyConfig): string {
...
function generateFaqBlocksHtml(config: AeorankEleventyConfig): string {
...
function generateCitationAnchorsHtml(config: AeorankEleventyConfig): string {
	return `<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="utf-8">
...
function generateSitemapAiXml(config: AeorankEleventyConfig): string {
...
const generators: Record<string, (config: AeorankEleventyConfig) => string> = {
 ...
 */
export function generateAeoFiles(config: AeorankEleventyConfig): string[] {
