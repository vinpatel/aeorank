...
function generateLlmsTxt(config: AeorankGatsbyConfig): string {
...
function generateLlmsFullTxt(config: AeorankGatsbyConfig): string {
	const faqSection =
...
function generateClaudeMd(config: AeorankGatsbyConfig): string {
	return `# ${config.siteName}
...
function generateSchemaJson(config: AeorankGatsbyConfig): string {
...
function generateFaqBlocksHtml(config: AeorankGatsbyConfig): string {
...
function generateCitationAnchorsHtml(config: AeorankGatsbyConfig): string {
	return `<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="utf-8">
...
function generateSitemapAiXml(config: AeorankGatsbyConfig): string {
...
const generators: Record<string, (config: AeorankGatsbyConfig) => string> = {
 ...
 */
export function generateAeoFiles(config: AeorankGatsbyConfig): string[] {
