...
import type { AeorankShopifyConfig } from "./types.js";
...
function generateLlmsTxt(config: AeorankShopifyConfig): string {
...
function generateLlmsFullTxt(config: AeorankShopifyConfig): string {
	const faqSection =
...
function generateClaudeMd(config: AeorankShopifyConfig): string {
	return `# ${config.siteName}
...
function generateSchemaJson(config: AeorankShopifyConfig): string {
...
function generateFaqBlocksHtml(config: AeorankShopifyConfig): string {
...
function generateCitationAnchorsHtml(config: AeorankShopifyConfig): string {
	return `<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="utf-8">
...
function generateSitemapAiXml(config: AeorankShopifyConfig): string {
...
const generators: Record<string, (config: AeorankShopifyConfig) => string> = {
 ...
 */
export function generateAeoFiles(config: AeorankShopifyConfig): string[] {
