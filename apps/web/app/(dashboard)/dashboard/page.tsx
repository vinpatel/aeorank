		...
		<div className="page-container animate-fade-in">
			<div className="rail" style={{ paddingTop: "4px", paddingBottom: "28px", marginBottom: "24px", borderBottom: "1px solid var(--rule)" }}>
				...
				<div style={{ display: "flex", alignItems: "end", justifyContent: "space-between", gap: "16px", flexWrap: "wrap" }}>
					<div>
						...
						<p className="text-sm text-secondary">Add a public URL. We'll run 36 checks and write the 8 files the CLI generates — crawler access and extractability, not a citation tracker.</p>
					</div>
			...
			{sites.length === 0 ? (
				<div className="empty-state">
					...
					<p className="text-sm font-medium">No sites yet. Add a public URL above — 36 checks, then a ZIP of the 8 files.</p>
				</div>
			) : (
